package com.john.render.entity;
...
public class RenderJoshpc extends RenderLiving
{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityJoshpc p_110775_1_)
    {
        return mobTextures;
    }
    ...
    {
        return this.getEntityTexture((EntityJoshpc) p_110775_1_);
    }
}
